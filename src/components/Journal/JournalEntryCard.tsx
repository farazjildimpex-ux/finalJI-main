    ...
    >
      <div className="relative flex flex-col px-4 py-3">
        ...
        <div className="flex items-baseline justify-between gap-2 mb-1">
          <h4 className="text-[13px] font-bold leading-tight tracking-tight line-clamp-1 flex-1 min-w-0 text-slate-900">
            {entry.title}
          </h4>
          ...
          <div className="absolute right-3 top-2.5 flex items-center gap-0.5 p-0.5 rounded-lg shadow-sm backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-150 shrink-0 bg-white/95 ring-1 ring-slate-200">
            <button
              ...
              className="p-1.5 rounded-md transition-colors text-slate-500 hover:text-blue-600 hover:bg-blue-50"
              title="Edit"
            >
        ...
        {/* Content preview */}
        {entry.content && (
          <p className="text-[12px] line-clamp-4 leading-relaxed mt-1 text-slate-600 whitespace-pre-wrap">
            {entry.content}
          </p>
        )}
      </div>
